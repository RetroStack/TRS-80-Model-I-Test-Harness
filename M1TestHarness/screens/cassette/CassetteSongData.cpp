...
const int imperialMelody[] PROGMEM = {
    ...
    NOTE_A5, NOTE_A4,  NOTE_A4,  NOTE_A5, NOTE_GS5, NOTE_G5,  NOTE_DS5, NOTE_D5, NOTE_DS5,
    REST,    NOTE_A4,  NOTE_DS5, NOTE_D5, NOTE_CS5, NOTE_C5,  NOTE_B4,  NOTE_C5, REST,
    NOTE_F4, NOTE_GS4, NOTE_F4,  NOTE_A4, NOTE_C5,  NOTE_A4,  NOTE_C5,  NOTE_E5,

    NOTE_A5, NOTE_A4,  NOTE_A4,  NOTE_A5, NOTE_GS5, NOTE_G5,  NOTE_DS5, NOTE_D5, NOTE_DS5,
    REST,    NOTE_A4,  NOTE_DS5, NOTE_D5, NOTE_CS5, NOTE_C5,  NOTE_B4,  NOTE_C5, REST,
    NOTE_F4, NOTE_GS4, NOTE_F4,  NOTE_A4, NOTE_A4,  NOTE_F4,  NOTE_C5,  NOTE_A4};

const float imperialDurations[] PROGMEM = {
    0.375, 0.375,  0.375,  0.25,    0.125,  0.375,  0.25,   0.125,  0.5,
    0.375, 0.375,  0.375,  0.25,    0.125,  0.375,  0.25,   0.125,  0.5,

    0.25,  0.1875, 0.0625, 0.25,    0.1875, 0.0625, 0.0625, 0.0625, 0.125,
    0.125, 0.125,  0.25,   0.1875,  0.0625, 0.0625, 0.0625, 0.0625, 0.125,
    0.125, 0.25,   0.1875, 0.09375, 0.25,   0.1875, 0.0625, 0.5,
