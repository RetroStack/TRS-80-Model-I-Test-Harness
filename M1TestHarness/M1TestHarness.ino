...
// Define compilation environment for Arduino IDE
#ifndef PLATFORMIO_COMPILATION
#define ARDUINO_IDE_COMPILATION
#endif

#include "./globals.h"
#include "./screens/WelcomeConsole.h"

// Arduino IDE helper - include all source files
#include "./arduino_ide_includes.h"
