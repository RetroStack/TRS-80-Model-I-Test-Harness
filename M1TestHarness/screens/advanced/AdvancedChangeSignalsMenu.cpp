...
unsigned long AdvancedChangeSignalsMenu::_getDurationMs(uint8_t durationIndex) {
...
uint8_t AdvancedChangeSignalsMenu::_getPatternValue8Bit(uint8_t mode, uint8_t currentValue) {
  switch (mode) {
    case 0:
      return 0x00;
    case 1:
...
uint16_t AdvancedChangeSignalsMenu::_getPatternValue16Bit(uint8_t mode, uint16_t currentValue) {
  switch (mode) {
    case 0:
      return 0x0000;
    case 1:
...
void AdvancedChangeSignalsMenu::_applySignalsToModel1() {
